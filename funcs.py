...
def talk_func(line_user_id, appUserId , message):
    ...
    if data=="場所ok":
        ...
        x2={ "type": "flex", "altText": "Flex Message", "contents": { "type": "bubble", "direction": "ltr", "header": { "type": "box", "layout": "vertical", "contents": [ { "type": "text", "text": "予約日を決定する", "align": "center" ,"color": "#221815"} ] }, "footer": { "type": "box", "layout": "horizontal", "contents": [ { "type": "button", "action": { "type":"datetimepicker", "label":"Select date", "data":"action=first", "mode":"date" } },"color": "#E5370A", "height": "md", "style": "primary" ] } } }
